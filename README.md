...
* [x] User can see retweet count
* [x] User can see favorite count
* [x] User can see UI indicator to see if the tweet is favorite or retweeted by them.
...
- combining swipe refresh with coordinator layout was challenging as well.
- First time undersatanding of how oauth works. 
