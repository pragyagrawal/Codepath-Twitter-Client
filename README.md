# Project 4 - *TwitterBook*

**TwitterBook** is an android app that allows a user to view home and mentions timelines, view user profiles with user timelines, as well as compose and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
[Video walkthrough](https://youtu.be/JZ9cHVNy3y4)

## Notes

- Reusing fragments at multiple places.

## Open-source libraries used

- [HTTPRestClient] - Rest client to access twitter api. 
